...
def get_prediction(image_data):
  ...
  url = 'https://askai.aiclub.world/85d508d9-5432-4f6d-a3c3-62303c77900d'  #Edit 2-- get endpoint URL from navigator by deploying your onnx model
...
st.title("Welcome to ecommerce Image Classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("ecommerce Image Classifier")#change according to your project   #Edit 3
...
with tab2:
  ...
  st.link_button("My Github Repository", "https://github.com/gsantosh18/ecommerce_ai") #Edit 4
  ...
  pdf_url = "https://raw.githubusercontent.com/gsantosh18/ecommerce_ai/main/sample.pdf"
